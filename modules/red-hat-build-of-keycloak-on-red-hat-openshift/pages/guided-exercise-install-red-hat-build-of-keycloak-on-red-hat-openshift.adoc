...
= Guided Exercise: Install Red Hat build of Keycloak on Red Hat OpenShift
:page-audio-src: guided-exercise-install-red-hat-build-of-keycloak-on-red-hat-openshift.wav
:page-transcript-src: guided-exercise-install-red-hat-build-of-keycloak-on-red-hat-openshift.txt
