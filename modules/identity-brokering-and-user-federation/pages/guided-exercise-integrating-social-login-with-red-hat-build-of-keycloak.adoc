...
:page-audio-src: guided-exercise-integrating-social-login-with-red-hat-build-of-keycloak.wav
:page-transcript-src: guided-exercise-integrating-social-login-with-red-hat-build-of-keycloak.txt
